...
draw_text(16, 144, "Animation Position: " + string(trkanimator.Layer(1).animationposition));
draw_text(16, 160, "Animation Frame: " + string(trkanimator.Layer(1).animationframe));
