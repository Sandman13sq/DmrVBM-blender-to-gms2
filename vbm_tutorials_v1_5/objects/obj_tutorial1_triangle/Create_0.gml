...
// Vertex attribute order MUST match format

// Draw a triangle with bottom-left red...
...
// ...and top blue
vertex_position_3d(vb_tri, 200, 100, 0); // Third Vertex = blue
vertex_color(vb_tri, c_blue, 1);
vertex_texcoord(vb_tri, 0, 0);

vertex_end(vb_tri); // Tell GM that the vertex buffer is finished
vertex_freeze(vb_tri); // We can freeze it to up performance, but we can't write to the buffer anymore
